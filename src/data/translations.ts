export const t = {
  ...
  redemptionHistory: { en: "Redemption History", zh: "兑换记录" },
  noRedemptions: { en: "No redemptions yet", zh: "暂无兑换记录" },
  noRedemptionsDesc: { en: "Redeem your points for rewards above!", zh: "使用积分兑换以上奖励吧！" },
