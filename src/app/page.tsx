...
import { Wrench, Star, Car, ChevronRight, Sparkles } from "lucide-react";
          ...
          {filtered.map((product, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="mt-0.5 inline-flex items-center gap-0.5 rounded-full bg-amber-50 px-1.5 py-0.5 text-[10px] font-semibold text-amber-600">
                  <Sparkles size={9} />
